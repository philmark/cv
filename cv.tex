...
% \jobtitle{Software Tester}{Volt Management Consulting}{Montreal, QC}{Summer
% 2008}
% \begin{jobdescription}
%   \item Tested quality, compatibility, and compliance of software using
%   DevTrack and DevTest, while working closely with the development team. 
% \end{jobdescription}
